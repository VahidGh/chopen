...
# # media_file = 'small_molecule_drugbank.csv'
#
# try:
#     df = pd.read_csv('https://raw.githubusercontent.com/plotly/dash-drug-discovery-demo/master/small_molecule_drugbank.csv')
# except ImportError as e:
#     df = None
#     raise e
#
# # df = []
# # f = default_storage.open(os.path.join(media_root, media_file), 'r')
# # data = csv.Sniffer().sniff(codecs.EncodedFile(f, "utf-8").read(1024))
# # f.open()
# # reader = csv.reader(codecs.EncodedFile(f, "utf-8"), delimiter=',', dialect=data)
# # for row in reader:
# #     df.append(row)
# # f.close()
# # print(df)
