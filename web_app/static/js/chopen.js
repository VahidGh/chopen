...
chopen.ajax = (function () {
    ...
    function defaultErrorCallBack(response, form) {
        chopen.notify.error(response.responseJSON.message);
    ...
    function submit(config) {
        ...
        var loadingMask = config.loadingMask || 'chopen-loading';
        ...
        var ajaxOptions = {
            ...
            success: function (response) {
                if (response.status == 'success') {
                    chopen.notify.success(response.result);
                } else {
                    chopen.notify.error(response.result);
                }
...
chopen.initApp = (function () {});


$(document).ready(chopen.initApp);